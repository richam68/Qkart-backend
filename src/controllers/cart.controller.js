...
const updateProductInCart = catchAsync(async (req, res) => {
  ...
  //if quantity is 0 then delete that product from cart = req.body.productId
  //now question from whom cart delete the product,
  //answer is from that particular user = req.user
